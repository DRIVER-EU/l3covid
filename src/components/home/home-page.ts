      ...
      m(
        ...
        m(".nav-wrapper", [
          m(
            ...
            m(`img[width=48][height=48][src=${logo}]`, {
        ...
        m(".row.container.center", [
          m(SlimdownView, {
            md: `## Learn and share
              ...
              The **COVID-19 Lessons Learned Library (L3)** is a repository in the domain of Crisis Management (CM) and Disaster Risk Reduction (DRR) for collecting and sharing lessons from preventive or response activities during the COVID-19 pandemic. More general lessons can be shared on the [l3crisis.eu](https://l3crisis.eu) website.`,
          }),
          m(".row", [
            m(
              ".col.s12.m4",
